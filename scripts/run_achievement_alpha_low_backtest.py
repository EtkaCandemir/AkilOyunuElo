...
OUTPUT_ROOT = ROOT / "output" / "achievement_alpha_low_backtest_2018_2026"
...
# The sweep on the production baseline was still falling at 0.2, so the grid
# reaches 0.0 - where the achievement term depends entirely on league
# strength and a title in the weakest league is worth nothing.
ACHIEVEMENT_ALPHAS = (0.0, 0.05, 0.1, 0.15, 0.2, 0.3)
