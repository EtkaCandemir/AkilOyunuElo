...
OUTPUT_ROOT = ROOT / "output" / "joint_low_gamma_alpha0_2018_2026"
...
# The joint surface put its optimum on the low-gamma edge once alpha reached 0,
# so the grid now reaches down past production's 0.80. If alpha alone carries
# the gain, the curve keeps falling towards 0.6 and gamma is not needed at all.
GAMMAS = (0.6, 0.8, 1.0, 1.2, 1.4)
ALPHAS = (0.0,)
